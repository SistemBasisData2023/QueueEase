...
function Sidebar() {
  ...
  return (
    <div className="fixed inset-y-0 left-1 bg-base-300 w-1/2 md:w-64" style={{ borderRadius: '30px' }}>
      ...
      <ul className="py-5">
        ...
        <li className="fixed bottom-8 left-1 px-4 text-xl font-medium">
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            />
            <div>
              <span style={{ fontWeight: 'bold', fontSize: '21px', marginTop: '-5px' }}>Nama Admin</span>
              <br />
